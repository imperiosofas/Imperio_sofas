    ...
    <section id="contato" className="relative overflow-hidden border-t border-gold/12 bg-[#d5a73a] py-20 text-ink sm:py-24 lg:py-28">
      ...
      <div className="shell relative">
        <Reveal className="max-w-4xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-black/65">Conte o tamanho da sua sala e o estilo que você procura. A equipe ajuda a encontrar a melhor opção.</p>
